            ...
            <div class="flex">
                <div class="rounded-xl border  my-8 ">
                    <form action="{{ route('trips.index') }}" method="GET"
                        ...
                        <div class="flex flex-col md:w-96 w-full">
                            <label for="area" class="text-sm font-medium text-stone-600">المنطقة</label>
                ...
                @forelse ($trips as $trip)
                    <div
                        ...
                        <div class="h-[300px] bg-cover bg-center relative "
                            ...
                            {{-- <div class="flex items-center absolute bottom-8 right-6  ">
                                ...
                                <svg class="w-4 h-4 ms-1 text-gray-300 dorktext-gray-500" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                                    <path
                                        d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z" />
                                </svg>
                            ...
                            <div class="m-6">
                                ...
                                <div class="p-3 bg-gray-200 rounded-md font-sec font-bold my-6 ">
                                    <div class="flex gap-2 mb-3 ">
                                        ...
                                        <p class="font-sec font-bold"> المناطق: </p>
                                    </div>
