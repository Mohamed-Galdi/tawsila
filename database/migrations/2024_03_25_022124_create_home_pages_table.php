...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('home_pages', function (Blueprint $table) {
            ...
            $table->string('our_university_1')->default('ourUniversities/الجامعة العربية المفتوحة.png');
            $table->string('our_university_2')->default('ourUniversities/جامعة الأميرة نورة بنت عبدالرحمن.png');
            $table->string('our_university_3')->default('ourUniversities/جامعة الملك سعود.png');
            $table->string('our_university_4')->default('ourUniversities/جامعة الامير سلطان.png');
            $table->string('our_university_5')->default('ourUniversities/جامعة الفيصل.png');
            $table->string('our_university_6')->default('ourUniversities/جامعة الملك سعود بن عبد العزيز للعلوم الصحية.png');
            $table->string('our_university_7')->default('ourUniversities/جامعة المعرفة.png');
            $table->string('our_university_8')->default('ourUniversities/جامعة دار العلوم.png');
            $table->string('our_university_9')->default('ourUniversities/جامعة رياض العلم.png');
            $table->string('our_university_10')->default('ourUniversities/كليات الرؤية.png');
            ...
            $table->string('1st_service_image')->default('ourServices/universities.jpg');
            ...
            $table->string('2nd_service_image')->default('ourServices/drivers.jpg');
            ...
            $table->string('3rd_service_image')->default('ourServices/buses.jpg');
